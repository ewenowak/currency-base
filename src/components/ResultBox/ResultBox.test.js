...
describe('Component ResultBox', () => {
    ...
    it('should render proper info about conversion when PLN -> USD', () => {
        ...
        for(const testAmount of testCases) {
            ...
            expect(output).toHaveTextContent(`${formatAmountInCurrency(testAmount, 'PLN')} = ${formatAmountInCurrency(testAmount/3.5, 'USD')}`.replace(/\u00a0/g, ' '));
            cleanup();
        };
    });
    ...
    it('should render proper info about conversion when USD -> PLN', () => {
        ...
        for(const testAmount of testCases) {
            ...
            const output = screen.getByTestId('output');
            expect(output).toHaveTextContent(`${formatAmountInCurrency(testAmount, 'USD')} = ${formatAmountInCurrency(testAmount*3.5, 'PLN')}`.replace(/\u00a0/g, ' '));
            cleanup();
        };
    });
    ...
    it('should render proper info about conversion when PLN -> PLN', () => {
        ...
        for(const testAmount of testCases) {
            ...
            const output = screen.getByTestId('output');
            expect(output).toHaveTextContent(`${formatAmountInCurrency(testAmount, 'PLN')} = ${formatAmountInCurrency(testAmount, 'PLN')}`.replace(/\u00a0/g, ' '));
            cleanup();
        };
    });
    ...
    it('should render proper info about conversion when USD -> USD', () => {
        ...
        for(const testAmount of testCases) {
            ...
            const output = screen.getByTestId('output');
            expect(output).toHaveTextContent(`${formatAmountInCurrency(testAmount, 'USD')} = ${formatAmountInCurrency(testAmount, 'USD')}`.replace(/\u00a0/g, ' '));
            cleanup();
        };
    });
    ...
    it('should render "Wrong value.." info about conversion when value is lower than zero', () => {
        ...
        for(const testAmount of testCasesMinusAmount) {
            render(<ResultBox from={testAmount.from} to={testAmount.to} amount={testAmount.amount} />);
